...
describe 'displaying NOT published articles', type: :feature do
 ...
 describe 'create comments', type: :feature do
   ...
   it 'should not add empty comment' do
     visit new_user_session_path
     fill_in 'Email', with: 'testadmin@admin.com'
     fill_in 'Password', with: 'qwerty'
     click_button 'Log in'
     ...
     expect(page).to have_content 'Comment can not be added'
   end

   it 'should add correct comment' do
     visit new_user_session_path
     fill_in 'Email', with: 'testadmin@admin.com'
     fill_in 'Password', with: 'qwerty'
     click_button 'Log in'
     visit root_path
     visit article_path(@article.id)
     fill_in 'Your comment', with: "Blablablablabla"
     click_button 'Enter comment'
     expect(page).to have_content 'Comment successfuly added'
   end
